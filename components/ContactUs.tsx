    ...
    <section id='contact' className='flex flex-col h-3/4 w-screen'>
      <div className='flex-grow flex'>
        ...
        <div className='md:p-12 p-4 bg-black md:w-1/3 flex flex-col justify-center'>
          <h1 className='md:text-4xl text-xl text-gray-100 font-bold'>CONTACT US</h1>
            <div className='mb-4'>
              ...
              <p className='flex text-gray-200 md:text-xl text-xs'> +971524531933 </p>
              <p className='flex text-gray-200 md:text-xl text-xs'> +971552769485 </p>
            </div>
        ...
        {/* Right Side - Map */}
        <div className='w-2/3'>
          <div className='md:p-8 p-2 h-full bg-black'>
