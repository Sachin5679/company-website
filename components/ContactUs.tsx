      ...
      <div className='flex-grow flex'>
        ...
        <div className='md:p-12 p-4 bg-black md:w-1/3 flex flex-col justify-center'>
          <h1 className='md:text-6xl text-xl text-gray-100 font-bold'>CONTACT US</h1>
            <div className='mb-4'>
              <p className='flex text-gray-200 md:text-xl text-xs mt-8'><span><MdLocationOn className='mt-1 mr-2 text-red-400' /></span>Arabilla Building, M28, Al Waheda, Dubai, U.A.E</p>
